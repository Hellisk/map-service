...
public interface SpatialQuery<T extends SpatialObject> {
     ...
     */
	XYObject<T> nearestNeighborSearch(double x, double y, DistanceFunction distFunc);
     ...
     * @return The nearest-neighbor from the object in the (x,y) position.
     */
	List<XYObject<T>> kNearestNeighborsSearch(double x, double y, int k, DistanceFunction distFunc);
