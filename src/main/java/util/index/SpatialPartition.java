 ...
 * <p>
 * Contains a list of spatial objects in a spatial partition (objects that intersect with the boundaries of the partition).
 *
 * @author uqdalves
 */
public abstract class SpatialPartition<XYObject> {
	/**
	...
	public SpatialPartition(String partitionId) {
		if (partitionId == null) {
			throw new NullPointerException("Spatial partition id cannot be null.");
		}
	 ...
	 * @return Returns False if the object does not intersect with this partition. True otherwise.
	 */
	public abstract boolean insert(XYObject obj);
	
	/**
	 * Insert all spatial objects in the list to this partition. Insert one by one.
	 *
	 * @param objList The list of spatial object to insert.
	 */
	public final void insertAll(List<XYObject> objList) {
		if (objList == null) {
			throw new NullPointerException("Objects list to insert cannot be null.");
		}
	 ...
	 * @return Return False if the object does not belong to this partition. True otherwise.
	 */
	public abstract boolean remove(XYObject obj);
	
	/**
	 * Remove all spatial objects in the list from this partition. Remove one by one.
	 *
	 * @param objList The list with the spatial objects to remove.
	 */
	public final void removeAll(List<XYObject> objList) {
		if (objList == null) {
			throw new NullPointerException("Objects list to remove cannot be null.");
		}
		for (XYObject obj : objList) {
			remove(obj);
		}
	...
	/**
	 * Returns the spatial object representing the boundaries of this spatial partition.
	 *
	...
	/**
	 * Returns an immutable/unmodifiable list containing the spatial objects in this partition.
	 *
	 * @return The list containing the spatial objects in this partition.
	 */
	...
	/**
	 * Check whether this spatial partition intersect with the given spatial object.
	 *
	 * @param obj The spatial object to check.
	 * @return True if this spatial partition intersect with the given spatial object.
	 */
