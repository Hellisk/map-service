...
/**
 * A grid partition data structure made of n x m cells. This Grid can hold any type of spatial object in 2D.
 * <p>
...
public class Grid<T extends SpatialObject> implements SpatialDataStructure<T> {
	...
	/**
	 * Create a new static grid partitioning of [n x m] cells with the given dimensions.
	 *
	...
	/**
	 * Return the partition in the position [i,j] in the grid. Grid i and j position start from [0,0].
	 *
	 * @param i cell position in the horizontal axis (x).
	 * @param j cell position in the vertical axis (y).
	 * @return The partition in the position [i,j] in the grid.
	 */
...
//                LOG.error("Error partition" + pos[0] + "," + pos[1]);
//            }
	...
	/**
	 * Return the adjacent partitions from the partition containing the object in the (x,y) position (if any).
	 *
	 * @param x Object's X coordinate.
	 * @param y Object's Y coordinate.
	 * @return A list of adjacent partitions, or an empty list if the object is out of the boundaries of this grid, or if there is no
	 * adjacent partitions.
	 */
	...
	/**
	 * Return the adjacent partitions from the given grid position [i,j] (if any).
	 *
	 * @param i cell position in the horizontal axis (x).
	 * @param j cell position in the vertical axis (y).
	 * @return An adjacent partitions list, or an empty list if there is no adjacent partition.
	 */
