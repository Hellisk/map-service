...
public class Decimal extends BigDecimal {
	...
	public Decimal sum(double val) {
		BigDecimal valBig = BigDecimal.valueOf(val).setScale(SCALE, ROUNDING_MODE);
		return new Decimal(super.add(valBig).doubleValue());
	}
	
	public Decimal sum(Decimal val) {
		return new Decimal(
				super.add(val).setScale(SCALE, ROUNDING_MODE).doubleValue());
	}
	...
	public Decimal sub(Decimal val) {
		return new Decimal(
				super.subtract(val).setScale(SCALE, ROUNDING_MODE).doubleValue());
	}
	...
	public Decimal divide(Decimal val) {
		return new Decimal(
				super.divide(val, ROUNDING_MODE).setScale(SCALE, ROUNDING_MODE).doubleValue());
	}
	...
	public Decimal multiply(Decimal val) {
		return new Decimal(
				super.multiply(val).setScale(SCALE, ROUNDING_MODE).doubleValue());
	}
	...
	public Decimal min(Decimal val) {
		return new Decimal(((BigDecimal) val).min(this).doubleValue());
	}
	...
	public Decimal max(Decimal val) {
		return new Decimal(((BigDecimal) val).max(this).doubleValue());
	}
	
	public Decimal sqrt() {
		BigDecimal val = BigDecimal.valueOf(Math.sqrt(this.doubleValue())).setScale(SCALE, ROUNDING_MODE);
	...
	public double value() {
		return BigDecimal.valueOf(doubleValue()).setScale(SCALE, ROUNDING_MODE).doubleValue();
	}
}
