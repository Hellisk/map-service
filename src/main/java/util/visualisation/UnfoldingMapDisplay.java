...
//import java.util.*;
//
//import static algorithm.cooptimization.CoOptimizationMain.*;
//
///**
...
//			MapReader csvRawMapReader = new MapReader(INPUT_MAP);
...
//					for (int i = 0; i < mapDisplay.length; i++) {
//						MapReader csvMapLevelReader = new MapReader(INPUT_MAP);
//						List<RoadWay> roadWayLevelList = csvMapLevelReader.readWays(0, i);
...
//						MapReader csvMapTypeReader = new MapReader(INPUT_MAP);
//						List<RoadWay> roadWayTypeList = csvMapTypeReader.readWays(0, i);
...
//				}
//				default: {
//					LOG.error("ERROR! Incorrect visualization option: " + OPTION);
//					break;
//				}
//			}
...
//					LOG.info("The current map contains " + processedRoadSize + " unvisited roads, which accounts for " +
...
//				currColor = lastColor;
//			} else LOG.error("ERROR! The visit count should not decrease.");
