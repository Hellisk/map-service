...
public class MultipleTrajectoryMatchResult {
	...
	public MultipleTrajectoryMatchResult(Trajectory traj, int requiredNumOfRanks) {
	...
	public MultipleTrajectoryMatchResult(Trajectory traj, int requiredNumOfRanks, int numOfRanks, List<List<PointMatch>> pointMatchResult,
	 ...
	 */
	public MultipleTrajectoryMatchResult(Trajectory traj, List<PointMatch> pointMatches, List<Route> routeMatches,
	 ...
	 */
	public MultipleTrajectoryMatchResult(List<MultipleTrajectoryMatchResult> matchResult, int requiredNumOfRanks) {
		if (matchResult == null)
		...
		this.requiredNumOfRanks = requiredNumOfRanks;
		this.numOfRanks = 0;
		for (MultipleTrajectoryMatchResult mr : matchResult) {
	...
	public static MultipleTrajectoryMatchResult parseTrajectoryMatchResult(String s, DistanceFunction df) {
		while (s.lastIndexOf("\n") == s.length() - 1)
		...
		return new MultipleTrajectoryMatchResult(currTraj, requiredNumOfRanks, numOfMatches, pointMatchList, routeMatchList, probabilities,
				breakPointBSList);
	}
	 ...
	 */
	public MultipleTrajectoryMatchResult getMatchResultAtRank(int rankIndex) {
		return new MultipleTrajectoryMatchResult(trajectory, pointMatchResult.get(rankIndex), routeMatchResult.get(rankIndex),
