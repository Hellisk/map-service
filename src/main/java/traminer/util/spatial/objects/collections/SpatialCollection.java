package traminer.util.spatial.objects.collections;

import traminer.util.Attributes;
import traminer.util.spatial.objects.ComplexSpatialObject;
...
public abstract class SpatialCollection<T extends SimpleSpatialObject>
    ...
    /**
     * Display this spatial object in a 2D graphical window.
     */
