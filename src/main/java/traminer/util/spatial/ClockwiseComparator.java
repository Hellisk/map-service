...
public class ClockwiseComparator<T extends Point> implements SpatialInterface, Comparator<T> {
     ...
     *
     * @param x,y The 'clock center' point (x,y) as referential.
     */
    ...
    public int compare(double x1, double y1, double x2, double y2) {
        ...
        double det = (x1 - center.x()) * (y2 - center.y()) - (x2 - center.x()) * (y1 - center.y());
        ...
        double d2 = (x2 - center.x()) * (x2 - center.x()) + (y2 - center.y()) * (y2 - center.y());
