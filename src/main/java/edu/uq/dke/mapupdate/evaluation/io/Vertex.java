...
public class Vertex implements Serializable {
    ...
    public double left = Double.MAX_VALUE, right = -1;//left and right endpoint of reachability interval or left is used as path label while computing shortest Paths.
