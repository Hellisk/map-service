...
public class Main {
    ...
    private final static int datasetOption = 1; // 0 = beijing trajectory, 1 = global trajectory
...
//    private final String OUTPUT_MAP = ROOT_PATH + "output/map/";
...
//        List<TrajectoryMatchResult> matchingResults = NewsonHMM2009.trajectoryMatchingProcess(initialTrajectoryList, initialMap, unmatchedTraj);
    ...
    private static void dataPreparation() throws IOException {
        ...
        RawFileOperation trajFilter = new RawFileOperation(500);
