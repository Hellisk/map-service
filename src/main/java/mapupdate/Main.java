...
public class Main {
    ...
    /* tunable parameters */
    public final static int PERCENTAGE = 5;         // percentage of removed road ways (max = 100)
    ...
    private final static double SCORE_THRESHOLD = 30;   // the value that divide the high and low influence/confidence score
    ...
    private final static int MAX_TRAJECTORY_DISTANCE = 50;    // maximum distance between two unmatched trajectories when merging clusters
...
//                while (iteration < 10) {
                    ...
                    if (IS_TC_MAP_INFERENCE) {
                        ...
                        inferenceResult = inferenceEdgeReader.readInferredEdges();
                    }
...
//    }
    ...
    (Stream<Trajectory> rawTrajectoryList, RoadNetworkGraph roadMap, int iteration, boolean refinementStep, CoOptimizationFunc coOptimizationFunc) throws IOException,
        ...
        return matchedResultPostProcess(roadMap, iteration, refinementStep, currMatchingResultList, unmatchedTrajInfo, coOptimizationFunc);
    }
