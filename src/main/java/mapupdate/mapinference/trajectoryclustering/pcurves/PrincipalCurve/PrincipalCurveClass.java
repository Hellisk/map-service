...
import mapupdate.mapinference.trajectoryclustering.pcurves.Optimize.Optimizable;
import mapupdate.mapinference.trajectoryclustering.pcurves.PrincipalCurve.Vertex.*;
...
//                    System.out.println("deleted " + GetVertexAt(i));
        ...
        /*
         * principalCurveParameters.diagnosisTextArea.append(mapupdate.mapinference.trajectoryclustering.pcurves.Utilities.Misc.FormatString(
         * objective,20,1)
         * + mapupdate.mapinference.trajectoryclustering.pcurves.Utilities.Misc.FormatString(MSE,20,1)
         * + mapupdate.mapinference.trajectoryclustering.pcurves.Utilities.Misc.FormatString(penalty,20,1)
         * + "\n");
         */
    }
