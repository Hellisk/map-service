...
import mapupdate.mapinference.trajectoryclustering.pcurves.LinearAlgebra.*;
import mapupdate.mapinference.trajectoryclustering.pcurves.PrincipalCurve.PrincipalCurveSampleVektor;
...
abstract public class Vertex extends Vektor2D {
    ...
    final protected EndVertexOfTwo MaintainEndVertex(Vertex neighbor) {
        ...
        } catch (mapupdate.mapinference.trajectoryclustering.pcurves.PrincipalCurve.Vertex.TwoOppositeEdgeIndexesException e1) {
            try {
                mapupdate.mapinference.trajectoryclustering.pcurves.PrincipalCurve.Vertex.YVertex realNeighbor =
                        (mapupdate.mapinference.trajectoryclustering.pcurves.PrincipalCurve.Vertex.YVertex) neighbor;
                return new EndVertexOfY(this, realNeighbor.GetEdgeIndex3(), realNeighbor.GetEdgeIndex1(), realNeighbor
                        .GetEdgeIndex2());
            } catch (ClassCastException e2) {
                mapupdate.mapinference.trajectoryclustering.pcurves.PrincipalCurve.Vertex.TVertex realNeighbor =
                        (mapupdate.mapinference.trajectoryclustering.pcurves.PrincipalCurve.Vertex.TVertex) neighbor;
                return new EndVertexOfTwo(this, realNeighbor.GetEdgeIndex(this).edgeIndex);
            }
        }
    }
