...
/*
 * javah -jni mapupdate.mapinference.trajectoryclustering.pcurves.LinearAlgebra.Vektor2D
...
//	static {
//		if (!mapupdate.mapinference.trajectoryclustering.pcurves.Utilities.Environment.inApplet)
...
//	}
    ...
    final public double Dist2(LineSegment lineSegment) {
        ...
        return distFunc.pointToSegmentDistance(coordX, coordY, coordX1, coordY1, coordX2, coordY2);
    }
    ...
    final public Vektor Project(LineSegment lineSegment) {
        ...
        double coordX2 = point2.coordX;
        double coordY2 = point2.coordY;
        Point resultPoint = distFunc.findClosestPoint(coordX, coordY, coordX1, coordY1, coordX2, coordY2);
    ...
    final public Vektor Project(Line line) {
        ...
        if (point1.equals(point2))
            return point1.Clone();
        Point resultPoint = distFunc.findClosestPointExtendable(coordX, coordY, point1.coordX, point1.coordY, point2.coordX, point2.coordY);
        return new Vektor2D(resultPoint.x(), resultPoint.y());
    }
