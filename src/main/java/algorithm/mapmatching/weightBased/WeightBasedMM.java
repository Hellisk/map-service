...
//	private List<Pair<Integer, List<PointMatch>>> outputPointMatchResult = new ArrayList<>();
	 ...
	 */
	private Pair<PointMatch, Integer> initialMM(Trajectory trajectory, int timestamp, List<String> matchedWaySequence, List<PointMatch> matchedPointSequence) {
	...
	public SimpleTrajectoryMatchResult offlineMatching(final Trajectory trajectory) {
		...
		// TODO PointMatch result must guarantee each point has a corresponding match.
