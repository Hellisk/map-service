...
public class SimpleHMMMapMatching extends MapMatchingMethod {
	...
	private final double dijkstraDist;
	
	
	public SimpleHMMMapMatching(RoadNetworkGraph roadMap, BaseProperty property) {
...
//        Set<PointMatch> neighbourPms = Minset.minimize(neighbourPms_, this.roadMap, this.distFunc);
	...
	/**
	 * Matches a full sequence of trajectory points and returns state representation of the full matching which is a SequenceMemory
	 * object. Output the map-matching result eventually.
	 *
	 * @param trajectory Sequence of samples, TrajectoryPoint objects.
