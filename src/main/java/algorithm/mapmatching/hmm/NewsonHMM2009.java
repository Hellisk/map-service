 ...
 * @since 22/05/2017
 */
public class NewsonHMM2009 implements Serializable {
	
	private static final Logger LOG = Logger.getLogger(NewsonHMM2009.class);
	...
	public NewsonHMM2009(RoadNetworkGraph roadNetworkGraph, BaseProperty prop) {
