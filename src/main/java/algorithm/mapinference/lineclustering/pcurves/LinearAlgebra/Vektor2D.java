...
/*
 * javah -jni algorithm.mapinference.lineclustering.pcurves.LinearAlgebra.Vektor2D
...
//	static {
//		if (!algorithm.mapinference.lineclustering.pcurves.Utilities.Environment.inApplet)
