package algorithm.mapinference.trajectoryclustering;

import algorithm.mapinference.trajectoryclustering.pcurves.PrincipalCurveGenerator;
...
public class TrajectoryClusteringMapInference {
	...
	public List<RoadWay> roadWayUpdateProcess(List<Triplet<Trajectory, String, String>> unmatchedTrajInfo, HashMap<String, Pair<HashSet<String>,
		...
		double maxAngleChange = prop.getPropertyDouble("algorithm.mapinference.traceclustering.MaximumAngleChangeDegree");
		double maxClusteringDist = prop.getPropertyDouble("algorithm.mapinference.traceclustering.MaximumClusteringDistance");
		double dpEpsilon = prop.getPropertyDouble("algorithm.mapinference.traceclustering.DPEpsilon");
