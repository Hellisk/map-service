...
def getGPSHistogram(lat2, lon2, lat1, lon1, lat0, lon0, radius, img_size, region, host="localhost", port=8002, center_lat=None,
                    center_lon=None, filename="tmp.png"):
    ...
    data_string = "G," + str(lat2) + "," + str(lon2) + "," + str(lat1) + "," + str(lon1) + "," + str(lat0) + "," + str(lon0) + "," + str(
        radius) + "," + str(minlat) + "," + str(minlon) + "," + str(maxlat) + "," + str(maxlon) + "," + str(img_size) + ", "
    # print(data_string)
    s.send(data_string)
...
def mergeDetector(path1, path2, port=8002):
    ...
    img1 = getGPSHistogram(path1[5][0], path1[5][1], path1[3][0], path1[3][1], path1[0][0], path1[0][1], 0.00005, 512, sub_region,
                           filename="path1.png", port=port)
    img2 = getGPSHistogram(path2[5][0], path2[5][1], path2[3][0], path2[3][1], path2[0][0], path2[0][1], 0.00005, 512, sub_region,
                           filename="path2.png", port=port)
