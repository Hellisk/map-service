    ...
    def process_trip(self, trip_directory, trip_filename, output_directory):
        ...
        for i in range(1, len(raw_observations)):
            ...
            if (distance > 10.0):
                ...
                for j in range(1, int_steps):
                    ...
                    (int_step_lat, int_step_lon) = spatialfunclib.point_along_line(float(prev_lat), float(prev_lon), float(curr_lat),
        ...
        for i in range(0, len(obs)):
            ...
            if (obs_states[i] == "unknown"):
                ...
                out_file.write(str(in_node_coords[0]) + " " + str(in_node_coords[1]) + " " + str(out_node_coords[0]) + " " + str(
                    out_node_coords[1]) + "\n")
