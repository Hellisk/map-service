    ...
    def process(self, matched_traces_filename, output_db_filename):
        ...
        while (True):
            ...
            if (len(candidate_segments) < 1):
                ...
                new_intersection = Node(new_intersection_latitude, new_intersection_longitude, node_id,
                ...
                if (segment_head_node in new_intersection.out_nodes): new_intersection.out_nodes.remove(
                    segment_head_node)
                if (segment_tail_node in new_intersection.out_nodes): new_intersection.out_nodes.remove(
                    segment_tail_node)
